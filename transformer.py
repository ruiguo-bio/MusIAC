...
class Transformer(Module):
    ...
    def forward(self, src: Tensor, tgt: Tensor, src_mask: Optional[Tensor] = None, tgt_mask: Optional[Tensor] = None,
        ...
        output,weights = self.decoder(tgt, memory, tgt_mask=tgt_mask, memory_mask=memory_mask,
...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
        ...
        weights = []
        for mod in self.layers:
            output,attention_weight = mod(output, memory, tgt_mask=tgt_mask,
...
class TransformerDecoderLayer(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None, memory_mask: Optional[Tensor] = None,
        ...
        tgt = self.norm1(tgt)
        tgt2, attention_weight = self.multihead_attn(tgt, memory, memory, attn_mask=memory_mask,
