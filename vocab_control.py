...
class WordVocab(object):
    def __init__(self, mode,control_list):
        ...
        if mode == 0:
            ...
            # step multi
            duration_only_token = duration_multi
            duration_tokens = step_token + duration_only_token + ['continue']
        ...
        #     all_tokens = basic_tokens + track_note_density_token
        # if 'polyphony' in control_list:
        #     all_tokens = basic_tokens + track_polyphony_rate_token
        # if 'occupation' in control_list:
        #     all_tokens = basic_tokens + track_occupation_rate_token
        #
        # if 'key' in control_list:
        #     all_tokens = basic_tokens + key_token
        #
        # if 'tensile' in control_list:
        #     all_tokens = basic_tokens + tensile_strain_token
        #
        # if 'diameter' in control_list:
        #     all_tokens = basic_tokens + diameter_token
